...
public class AuditeeActivity extends AppCompatActivity {

    DatabaseHelper myDb;
    Button btnAuditeeWip,btnAuditeeRm,btnAuditeeWipDelete,btnAuditeeRmDelete,btnAuditeeExport,btnAuditeeWipEdit,btnAuditeeRmEdit,btnAuditeeExit;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.auditee);


//        this.setTitle("Auditee");
        myDb = new DatabaseHelper(this);

        btnAuditeeWip = (Button)findViewById(R.id.btnAuditeeWip);
        btnAuditeeRm = (Button)findViewById(R.id.btnAuditeeRm);
        btnAuditeeExport = (Button)findViewById(R.id.btnAuditeeExport);
        btnAuditeeWipDelete = (Button)findViewById(R.id.btnAuditeeWipDelete);
        btnAuditeeRmDelete = (Button)findViewById(R.id.btnAuditeeRmDelete);
        btnAuditeeWipEdit = (Button)findViewById(R.id.btnAuditeeWipEdit);
        btnAuditeeRmEdit = (Button)findViewById(R.id.btnAuditeeRmEdit);
        btnAuditeeExit = (Button)findViewById(R.id.btnAuditeeExit);


        LinkWip();
        LinkRm();
        LinkAuditeeWipDelete();
        LinkAuditeeRmDelete();
        LinkAuditeeWipEdit();
        LinkAuditeeRmEdit();
        exportExcel();
        eventOnClickBtnAuditeeExit();
    }
...
//    }
    ...
    public void LinkWip()
    {
        btnAuditeeWip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Open Result
                Intent newActivity = new Intent(AuditeeActivity.this,AuditeeWipActivity.class);
    ...
    public void LinkRm()
    {
        btnAuditeeRm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Open Result
                Intent newActivity = new Intent(AuditeeActivity.this,AuditeeRmActivity.class);
                startActivity(newActivity);
            }
        });
    }

    public void LinkAuditeeWipDelete()
    {
        btnAuditeeWipDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Open Result
                Intent newActivity = new Intent(AuditeeActivity.this,AuditeeWipDeleteActivity.class);
                startActivity(newActivity);
            }
        });
    }

    public void LinkAuditeeWipEdit()
    {
        btnAuditeeWipEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Open Result
                Intent newActivity = new Intent(AuditeeActivity.this,AuditeeWipEditActivity.class);
                startActivity(newActivity);
            }
        });
    }

    public void LinkAuditeeRmEdit()
    {
        btnAuditeeRmEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Open Result
                Intent newActivity = new Intent(AuditeeActivity.this,AuditeeRmEditActivity.class);
                startActivity(newActivity);
            }
        });
    }

    public void LinkAuditeeRmDelete()
    {
        btnAuditeeRmDelete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Open Result
                Intent newActivity = new Intent(AuditeeActivity.this,AuditeeRmDeleteActivity.class);
                startActivity(newActivity);
            }
        });
    }

    public void eventOnClickBtnAuditeeExit()
    {
        btnAuditeeExit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Open Result
                onBackPressed();
    ...
    {
        btnAuditeeExport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                File directory = new File(sd.getAbsolutePath() + "/Export/Auditee/Wips");
...
//                            sheet.setColumnView(8, cell);
                            ...
                            if (cParts.moveToFirst()) {
                                do {
                                    ...
                                    sheet.addCell(new Label(5, i+8, "0",cellFormatListPart));
                ...
                directory = new File(sd.getAbsolutePath() + "/Export/Auditee/RMs");
...
//                            sheet.setColumnView(8, cell);
                            ...
                            if (cParts.moveToFirst()) {
                                do {
                                    String partname = cParts.getString(cParts.getColumnIndex("partname"));
                                    String qtyAuditee = cParts.getString(cParts.getColumnIndex("qty"));
                                    String qtyAuditor = cParts.getString(2);
